...
map.getView().fit([-8778930.984565, -2671729.244185, -5363057.704879, -983781.756185], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CENSO DE POBLACIÓN 2024</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_Cartevecteurensortie_1,
    colName: 'MUNICIPIO',
    zoom: 10,
    collapsed: true,
    map: map,
